...
- 어림수의 마력
  - 현재사회는 숫자 정보사회(숫자화 사회)임.
  - 숫자를 올바르게 이해할 수 있는 능력은 빅데이터 시대에 기본적이고 필수적인 능력임.
  - 어림수일지라도 숫자에 주눅이 들어 있는 대부분의 사람들에게는 효과 발휘

- 어림수의 정확성
  - 데이터가 명확하지 않다면 불신이 쌓임
- 어림수의 대응
  - 상식적으로 생각해보기
  - 어림수의 근거에 대한 질문
  - 상대방의 주장을 입증하는 추가 증거가 있는지 확인
  - 관련성 ( 해당 주제와 직접적으로 관련이 있는가?)
  - 정확성 (누가, 어떻게 그 숫자를 만들어 냈는지, 왜 그런 방법을 사용했는지, 어떤 의도가 개입되어 있는지?)
  - 올바른 해석
...
- 창의성은 분석에서 싹 튼다.
  - 창의력은 어디서 발현하는가? (대부분 계량적 분석이 창의력의 원천으로 보고 있음)
  - 창의력과 분석은 밀접한 관계가 있음.

![image-20211229183852466](Elearning_BigData.assets/image-20211229183852466.png)

- 
  - 창의성은 타고난 것이 아니라 분석능력을 통해 기를수 있는 것이다.
- 분석 능력 키우기
  - 관련 연구를 조사하고, 선정된 변수를 측정하여 변수 간의 새로운 관련성을 파악하는 과정에서 오는 영감!
  - 신경세포틑 계속적인 분석에 의해서 훈련될 수 있음

- 창의성은 패턴 찾기
  - 창의성은 존재하지 않는(우리가 아직 파악하지 못한, 변수간의 규칙적 패턴) 관계를 보는 능력
